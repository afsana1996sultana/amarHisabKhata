                    ...
                    <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                        <div class="card">
                            <div class="card-header">
                                <h5 class=" float-left">Lead Info Create</h5>
                            ...
                            <div class="card-body">
                                <form action="{{ route('lead.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input id="name" name="lead_name" type="text" class="form-control @error('lead_name') is-invalid @enderror" value="" placeholder="lead name">
                                                @error('lead_name')
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input id="phone" name="lead_phone" type="number" class="form-control @error('lead_phone') is-invalid @enderror" value="" placeholder="lead phone" >
                                                @error('lead_phone')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="email" type="text" class="form-control" value="" placeholder="lead email">
                                                @error('email')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group has-success">
                                                ...
                                                <textarea name="address" id="address" rows="1" class="form-control @error('address') is-invalid @enderror" placeholder="lead address"></textarea>
                                                @error('address')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <textarea name="description" id="description" rows="5" class="form-control @error('description') is-invalid @enderror" placeholder="write lead description...."></textarea>
                                        @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" class="btn btn-space btn-primary btn-sm">Create</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
