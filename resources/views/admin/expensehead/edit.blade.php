                ...
                <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" float-left">Account Heads Update</h5>
                        ...
                        <div class="card-body">
                            <form action="{{ route('expense-head.update',$expenseheads->id) }}" method="post" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            <label for="title">Title <small class="text-danger">*</small></label>
                                            <input id="title" type="text" name="title" value="{{ $expenseheads->title }}" required="" class="form-control">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="form-check-input me-2 cursor" name="status"id="status" {{ $expenseheads->status == 1 ? 'checked': '' }} value="1">
