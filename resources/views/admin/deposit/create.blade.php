                ...
                <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" float-left">Deposit Create</h5>
                            <h4 class="float-right">
                                @if(Auth::user()->user_role == 1 || in_array('14', json_decode(Auth::user()->staff->role->permissions)))
                                    <a href="{{ route('deposit.index') }}" class="btn btn-outline-dark btn-xs float-end" style="padding: 4px 12px"><i class="fas fa-plus"></i>Back</a>
                                @endif
                            </h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('deposit.store') }}" method="post"  data-parsley-validate="">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
