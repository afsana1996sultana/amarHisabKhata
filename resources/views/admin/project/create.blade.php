                    ...
                    <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
                        <div class="card">
                            <div class="card-header">
                                <h5 class=" float-left">Project Info Create</h5>
                            ...
                            <div class="card-body">
                                <form action="{{route('project.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <input id="lead_id" type="hidden" name="lead_id" class="form-control">
                                        <div class="col-12">
                                            <div class="form-group from_group_mobile">
                                                ...
                                                <select class="form-control select-active w-100 form-select select-nice" name="customer_name" id="customer_name">
                                                    ...
                                                    @foreach($customers as $customer)
                                                        <option value="{{ $customer->lead_name }}">{{ $customer->lead_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group from_group_mobile">
                                                ...
                                                <input id="customer_phone" type="number" name="customer_phone" data-parsley-trigger="change" autocomplete="off" class="form-control" readonly>
                                            </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            <div class="form-group from_group_mobile">
                                                ...
                                                <input id="customer_email" type="email" name="customer_email" data-parsley-trigger="change" autocomplete="off" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group from_group_mobile">
                                                <label for="address">Address </label>
                                                <textarea class="form-control" name="address" id="address" cols="10" rows="3" readonly></textarea>
                                            </div>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <div class="form-group from_group_mobile">
                                                <label for="project_name">Project Name<small class="text-danger">*</small></label>
                                                <input id="project_name" type="text"  name="project_name" data-parsley-trigger="change" autocomplete="off" class="form-control">
                                            </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            <div class="form-group from_group_mobile">
                                                ...
                                                <input id="project_value" type="number" name="project_value" data-parsley-trigger="change" autocomplete="off" class="form-control">
                                            </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            <div class="form-group from_group_mobile">
                                                ...
                                                <input id="advance" type="number" name="advance" data-parsley-trigger="change" autocomplete="off" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <div class="form-group from_group_mobile">
                                                <label for="paid" style="display: none">Paid </label>
                                                <input id="paid" type="hidden" name="paid" data-parsley-trigger="change" autocomplete="off" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <div class="form-group from_group_mobile">
                                                <label for="due">Due </label>
                                                <input id="due" type="number" name="due" data-parsley-trigger="change" autocomplete="off" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <div class="form-group from_group_mobile">
                                                <label for="project_duration">Project Duration </label>
                                                <input id="project_duration" type="text" name="project_duration" data-parsley-trigger="change" autocomplete="off" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group from_group_mobile">
                                        ...
                                        <div class="col-12 mt-3">
                                            <div class="form-group from_group_mobile">
                                                ...
                                                <input id="date" type="date" name="date" data-parsley-trigger="change" autocomplete="off" class="form-control" value="{{ old('date', date('Y-m-d')) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
