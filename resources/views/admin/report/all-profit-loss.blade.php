    ...
    <div class="container-fluid profitLossDiv">
        <div class="row card p-2">
            <div class="box box-primary no-print">
                <h3 class="text-center mt-3">All Profit Loss Report</h3>
                <form action="{{ route('report.all-profit-loss-filter') }}" method="get">
                    <div class="col-12 col-md-4 offset-md-4">
                        <div class="invoice-basic-information no-print d-flex items-center">
                            ...
                            <button type="submit" class="action__button btn btn-sm btn-success d-flex" style="align-items: center; gap:5px; background: #5969ff">
                        ...
                        @if(isset($project) && count($project) > 0)
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        <td class="text-center">{{$profitLossLabel}}</td>
                                        <td>{{ $profitLossValue }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
