                ...
                <div class="col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="float-left">Role Permission Edit</h5>
                        ...
                        <div class="card-body">
                            <form action="{{ route('roles.update', $roles->id) }}" method="post" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            <label for="name">Name <small class="text-danger">*</small></label>
                                            <input id="name" type="text" name="name" value="{{ $roles->name ?? '' }}" placeholder="Name" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-3">
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox1" name="permissions[]" value="1" @if(in_array(1, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox2" name="permissions[]" value="2" @if(in_array(2, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox3" name="permissions[]" value="3" @if(in_array(3, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox4" name="permissions[]" value="4" @if(in_array(4, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox5" name="permissions[]" value="5" @if(in_array(5, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox6" name="permissions[]" value="6" @if(in_array(6, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox7" name="permissions[]" value="7" @if(in_array(7, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox8" name="permissions[]" value="8" @if(in_array(8, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox9" name="permissions[]" value="9" @if(in_array(9, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox10" name="permissions[]" value="10" @if(in_array(10, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox11" name="permissions[]" value="11" @if(in_array(11, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox12" name="permissions[]" value="12" @if(in_array(12, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox13" name="permissions[]" value="13" @if(in_array(13, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox14" name="permissions[]" value="14" @if(in_array(14, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox15" name="permissions[]" value="15" @if(in_array(15, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox16" name="permissions[]" value="16" @if(in_array(16, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox17" name="permissions[]" value="17" @if(in_array(17, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox18" name="permissions[]" value="18" @if(in_array(18, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox19" name="permissions[]" value="19" @if(in_array(19, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox20" name="permissions[]" value="20" @if(in_array(20, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox21" name="permissions[]" value="21" @if(in_array(21, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox22" name="permissions[]" value="22" @if(in_array(22, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox23" name="permissions[]" value="23" @if(in_array(23, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox24" name="permissions[]" value="24" @if(in_array(24, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox25" name="permissions[]" value="25" @if(in_array(25, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox26" name="permissions[]" value="26" @if(in_array(26, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox27" name="permissions[]" value="27" @if(in_array(27, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox28" name="permissions[]" value="28" @if(in_array(28, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox29" name="permissions[]" value="29" @if(in_array(29, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox30" name="permissions[]" value="30" @if(in_array(30, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox31" name="permissions[]" value="31" @if(in_array(31, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox32" name="permissions[]" value="32" @if(in_array(32, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox33" name="permissions[]" value="33" @if(in_array(33, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox34" name="permissions[]" value="34" @if(in_array(34, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox35" name="permissions[]" value="35" @if(in_array(35, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox36" name="permissions[]" value="36" @if(in_array(36, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox37" name="permissions[]" value="37" @if(in_array(37, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox38" name="permissions[]" value="38" @if(in_array(38, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox39" name="permissions[]" value="39" @if(in_array(39, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox40" name="permissions[]" value="40" @if(in_array(40, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox41" name="permissions[]" value="41" @if(in_array(41, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox42" name="permissions[]" value="42" @if(in_array(42, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox43" name="permissions[]" value="43" @if(in_array(43, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox44" name="permissions[]" value="44" @if(in_array(44, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox45" name="permissions[]" value="45" @if(in_array(45, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox46" name="permissions[]" value="46" @if(in_array(46, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox47" name="permissions[]" value="47" @if(in_array(47, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox48" name="permissions[]" value="48" @if(in_array(48, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox49" name="permissions[]" value="49" @if(in_array(49, $permissions)) checked @endif>
                                                 ...
                                                 <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox50" name="permissions[]" value="50" @if(in_array(50, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox51" name="permissions[]" value="51" @if(in_array(51, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox52" name="permissions[]" value="52" @if(in_array(52, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox53" name="permissions[]" value="53" @if(in_array(53, $permissions)) checked @endif>
                                                 ...
                                                 <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox54" name="permissions[]" value="54" @if(in_array(54, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox55" name="permissions[]" value="55" @if(in_array(55, $permissions)) checked @endif>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox56" name="permissions[]" value="56" @if(in_array(56, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox57" name="permissions[]" value="57" @if(in_array(57, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox58" name="permissions[]" value="58" @if(in_array(58, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox59" name="permissions[]" value="59" @if(in_array(59, $permissions)) checked @endif>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                                    <div class="p-2 border mt-1 mb-4 checkbox_custom">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="checkbox60" name="permissions[]" value="60" @if(in_array(60, $permissions)) checked @endif>
